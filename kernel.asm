...
//    uint64 arg0;
    ...
    80001e34:	00008067          	ret
        if(a0reg==0x11){
    80001e38:	01100793          	li	a5,17
    80001e3c:	06f48463          	beq	s1,a5,80001ea4 <_ZN5Riscv20handleSupervisorTrapEv+0xcc>
        if(a0reg== 0x01 ){
    80001e40:	00100793          	li	a5,1
    80001e44:	0cf48463          	beq	s1,a5,80001f0c <_ZN5Riscv20handleSupervisorTrapEv+0x134>
        else if(a0reg==0x02){
    80001e48:	00200793          	li	a5,2
    80001e4c:	0ef48e63          	beq	s1,a5,80001f48 <_ZN5Riscv20handleSupervisorTrapEv+0x170>
        else if(a0reg==0x12){
    80001e50:	01200793          	li	a5,18
    80001e54:	12f48663          	beq	s1,a5,80001f80 <_ZN5Riscv20handleSupervisorTrapEv+0x1a8>
        else if(a0reg == 0x13){
    80001e58:	01300793          	li	a5,19
    80001e5c:	16f48463          	beq	s1,a5,80001fc4 <_ZN5Riscv20handleSupervisorTrapEv+0x1ec>
        else if(a0reg==0x04){
    80001e60:	00400793          	li	a5,4
...
inline uint64 Riscv::r_sstatus()
{
    ...
    80001e94:	3d4080e7          	jalr	980(ra) # 80001264 <_ZN7_thread8dispatchEv>
}
...
inline void Riscv::w_sstatus(uint64 sstatus)
{
    ...
    80001ec0:	05843583          	ld	a1,88(s0)
            __asm__ volatile("ld a2, 12*8(fp)"); //a2
    80001ec4:	06043603          	ld	a2,96(s0)
            __asm__ volatile("ld a3, 13*8(fp)"); //a3
    80001ec8:	06843683          	ld	a3,104(s0)
            __asm__ volatile("ld a4, 14*8(fp)"); //a4
    80001ecc:	07043703          	ld	a4,112(s0)
            __asm__ volatile("mv %0, a1" : "=r" (arg1));    //handle (thread_t*)
    80001ed0:	00058a13          	mv	s4,a1
            __asm__ volatile("mv %0, a2" : "=r" (arg2));    //start routine
    80001ed4:	00060513          	mv	a0,a2
            __asm__ volatile("mv %0, a3" : "=r" (arg3));    //argument of start routine
    80001ed8:	00068593          	mv	a1,a3
            __asm__ volatile("mv %0, a4" : "=r" (arg4));    //stack
    80001edc:	00070613          	mv	a2,a4
            _thread* t = _thread::createThread(arg2,  (void*)arg3, arg4);    //t je thread_t
    80001ee0:	fffff097          	auipc	ra,0xfffff
    80001ee4:	464080e7          	jalr	1124(ra) # 80001344 <_ZN7_thread12createThreadEPFvPvES0_Pm>
            *arg1=t;
    80001ee8:	00aa3023          	sd	a0,0(s4)
            if(t!= nullptr)ret=0;
    80001eec:	00050c63          	beqz	a0,80001f04 <_ZN5Riscv20handleSupervisorTrapEv+0x12c>
    80001ef0:	00000793          	li	a5,0
            __asm__ volatile("mv a0, %0" : : "r" (ret));
    80001ef4:	00078513          	mv	a0,a5
    __asm__ volatile ("csrw sstatus, %[sstatus]" : : [sstatus] "r"(sstatus));
    80001ef8:	10099073          	csrw	sstatus,s3
    __asm__ volatile ("csrw sepc, %[sepc]" : : [sepc] "r"(sepc));
    80001efc:	14191073          	csrw	sepc,s2
}
    80001f00:	f41ff06f          	j	80001e40 <_ZN5Riscv20handleSupervisorTrapEv+0x68>
            else ret =-1;
    80001f04:	fff00793          	li	a5,-1
    80001f08:	fedff06f          	j	80001ef4 <_ZN5Riscv20handleSupervisorTrapEv+0x11c>
    __asm__ volatile ("csrr %[sepc], sepc" : [sepc] "=r"(sepc));
    80001f0c:	141027f3          	csrr	a5,sepc
    80001f10:	f8f43423          	sd	a5,-120(s0)
    return sepc;
    80001f14:	f8843483          	ld	s1,-120(s0)
            uint64 sepc = r_sepc() + 4;
    80001f18:	00448493          	addi	s1,s1,4
    __asm__ volatile ("csrr %[sstatus], sstatus" : [sstatus] "=r"(sstatus));
    80001f1c:	100027f3          	csrr	a5,sstatus
    80001f20:	f8f43023          	sd	a5,-128(s0)
    return sstatus;
    80001f24:	f8043903          	ld	s2,-128(s0)
            __asm__ volatile("mv %0, a1" : "=r" (arg1));    //read size from a1 and move it to arg1 local variable
    80001f28:	00058513          	mv	a0,a1
            uint64 ptr= (uint64) MemoryAllocator::kmem_alloc(arg1*MEM_BLOCK_SIZE);
    80001f2c:	00651513          	slli	a0,a0,0x6
    80001f30:	00000097          	auipc	ra,0x0
    80001f34:	0c4080e7          	jalr	196(ra) # 80001ff4 <_ZN15MemoryAllocator10kmem_allocEm>
            __asm__ volatile("mv a0, %0" : : "r" (ptr));
    80001f38:	00050513          	mv	a0,a0
    __asm__ volatile ("csrw sstatus, %[sstatus]" : : [sstatus] "r"(sstatus));
    80001f3c:	10091073          	csrw	sstatus,s2
    __asm__ volatile ("csrw sepc, %[sepc]" : : [sepc] "r"(sepc));
    80001f40:	14149073          	csrw	sepc,s1
}
    80001f44:	ed5ff06f          	j	80001e18 <_ZN5Riscv20handleSupervisorTrapEv+0x40>
    __asm__ volatile ("csrr %[sepc], sepc" : [sepc] "=r"(sepc));
    ...
    80001f6c:	0b4080e7          	jalr	180(ra) # 8000201c <_ZN15MemoryAllocator9kmem_freeEPv>
            __asm__ volatile("mv a0, %0" : : "r" (ret));
    80001f70:	00050513          	mv	a0,a0
    __asm__ volatile ("csrw sstatus, %[sstatus]" : : [sstatus] "r"(sstatus));
    80001f74:	10091073          	csrw	sstatus,s2
    __asm__ volatile ("csrw sepc, %[sepc]" : : [sepc] "r"(sepc));
    80001f78:	14149073          	csrw	sepc,s1
}
    80001f7c:	e9dff06f          	j	80001e18 <_ZN5Riscv20handleSupervisorTrapEv+0x40>
    __asm__ volatile ("csrr %[sepc], sepc" : [sepc] "=r"(sepc));
    80001f80:	141027f3          	csrr	a5,sepc
    80001f84:	faf43423          	sd	a5,-88(s0)
    return sepc;
    80001f88:	fa843483          	ld	s1,-88(s0)
            uint64 sepc = r_sepc() + 4;
    ...
    return sstatus;
    80001f98:	fa043903          	ld	s2,-96(s0)
            _thread::running->finished=true;
    80001f9c:	00004797          	auipc	a5,0x4
    80001fa0:	a747b783          	ld	a5,-1420(a5) # 80005a10 <_GLOBAL_OFFSET_TABLE_+0x8>
    80001fa4:	0007b783          	ld	a5,0(a5)
    80001fa8:	00100713          	li	a4,1
    80001fac:	02e78423          	sb	a4,40(a5)
            _thread::dispatch();
    80001fb0:	fffff097          	auipc	ra,0xfffff
    80001fb4:	2b4080e7          	jalr	692(ra) # 80001264 <_ZN7_thread8dispatchEv>
    __asm__ volatile ("csrw sstatus, %[sstatus]" : : [sstatus] "r"(sstatus));
    80001fb8:	10091073          	csrw	sstatus,s2
    __asm__ volatile ("csrw sepc, %[sepc]" : : [sepc] "r"(sepc));
    80001fbc:	14149073          	csrw	sepc,s1
}
    80001fc0:	e59ff06f          	j	80001e18 <_ZN5Riscv20handleSupervisorTrapEv+0x40>
    __asm__ volatile ("csrr %[sepc], sepc" : [sepc] "=r"(sepc));
    80001fc4:	141027f3          	csrr	a5,sepc
    80001fc8:	faf43c23          	sd	a5,-72(s0)
    return sepc;
    80001fcc:	fb843483          	ld	s1,-72(s0)
            uint64 sepc = r_sepc() + 4;
    80001fd0:	00448493          	addi	s1,s1,4
    __asm__ volatile ("csrr %[sstatus], sstatus" : [sstatus] "=r"(sstatus));
    80001fd4:	100027f3          	csrr	a5,sstatus
    80001fd8:	faf43823          	sd	a5,-80(s0)
    return sstatus;
    80001fdc:	fb043903          	ld	s2,-80(s0)
            _thread::dispatch();
    80001fe0:	fffff097          	auipc	ra,0xfffff
    80001fe4:	284080e7          	jalr	644(ra) # 80001264 <_ZN7_thread8dispatchEv>
    __asm__ volatile ("csrw sstatus, %[sstatus]" : : [sstatus] "r"(sstatus));
